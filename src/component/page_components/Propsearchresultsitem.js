...
class Propsearchresultitem extends Component{
    render(){
        const {id, description, name, owner, price, pricebasis, imagesrc} = this.props.details;
        return(
            <Link to={{
...
export default Propsearchresultitem;